...
const flipCards = [
  { title: "Pecinta Musik", subtitle: "Konser, Gig, Festival", img: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=400&h=500&fit=crop", desc: "Dari indie lokal sampai artis internasional — semua tiket tersedia di TiketIn dengan harga resmi tanpa markup dari calo.", color: "#7C3AED" },
  { title: "Event Seeker", subtitle: "Festival, Pameran, Sport", img: "https://images.unsplash.com/photo-1506157786151-b8491531f063?w=400&h=500&fit=crop", desc: "Jangan lewatkan satu pun event seru di kotamu. Pantau jadwal, set reminder, dan beli tiket sebelum sold out.", color: "#F59E0B" },
  { title: "Event Organizer", subtitle: "Kelola & Jual Tiket", img: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=500&fit=crop", desc: "Buat event, atur kategori tiket, pantau penjualan real-time, dan akses laporan lengkap melalui dashboard admin.", color: "#EC4899" },
  { title: "Keluarga & Komunitas", subtitle: "Outing, Gathering, Wisata", img: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=400&h=500&fit=crop", desc: "Rencanakan outing keluarga atau gathering komunitas dengan mudah. Beli tiket massal dengan harga grup yang spesial.", color: "#059669" },
];
      ...
      <section style={{ position: "relative", height: "100svh", minHeight: 560, overflow: "hidden" }}>
        ...
        <div className="hero-content-wrap" style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 3, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 24px 24px" }}>
          ...
          <p className="h3" style={{ fontSize: "clamp(12px, 1.8vw, 15px)", color: "rgba(255,255,255,0.88)", marginBottom: 22, fontWeight: 600, textAlign: "center", maxWidth: 480 }}>
            Konser · Festival · Olahraga · Pameran — tiket resmi, harga transparan, anti calo
          </p>
